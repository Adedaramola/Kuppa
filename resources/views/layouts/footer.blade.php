<footer>
    <div class="px-4 py-6 flex flex-col items-center text-center bg-yellow-100">
        ...
        <div class="mt-10 text-sm">You would receive emails on new arrivals in the store. Subscribing means you agree to our <a href="#" class="pb-1 border-b border-black">terms and conditions.</a></div>
    </div>
    ...
    <div class="md:hidden">
        <ul class="mt-3" x-data="{ selected:null }">
            <li class="relative border-b border-gray-100">
                <button x-on:click="selected !== 1 ? selected = 1 : selected = null" type="button" class="w-full px-4 py-3 flex
            ...
            <li class="relative border-b border-gray-100">
                <button x-on:click="selected !== 2 ? selected = 2 : selected = null" type="button" class="w-full px-4 py-3 flex
            justify-between items-center bg-gray-50">
            ...
            <li class="relative border-b border-gray-100">
                <button x-on:click="selected !== 3 ? selected = 3 : selected = null" type="button" class="w-full px-4 py-3 flex
            justify-between items-center bg-gray-50">
    ...
    <div class="bg-black">
        <section class="flex justify-between items-center px-5 py-4 text-white text-xs mx-auto lg:max-w-6xl">
